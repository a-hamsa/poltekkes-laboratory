        ...
        <div class="card bg-white text-gray-800 shadow-lg rounded-lg overflow-hidden">
            <div class="card-body p-6">
                ...
                <a href="{{ route('schedules.create') }}"
                    class="btn bg-primary hover:bg-primary-dark text-white py-2 px-4 rounded">
                    Create New Schedule
                </a>
                        ...
                        @foreach ($schedules as $schedule)
                            <tr>
                                ...
                                <td class="border px-4 py-2">
                                    <a href="{{ asset('storage/uploads/' . $schedule->pdf_file) }}" target="_blank"
                                        class="text-primary">
                                        View PDF
                                    </a>
                                </td>
                                <td class="border px-4 py-2">
                                    <img src="{{ asset('storage/uploads/qrcodes/' . $schedule->qr_code) }}" alt="QR Code"
                                        class="w-16 h-16 mb-2">
                                    <a href="{{ asset('storage/uploads/qrcodes/' . $schedule->qr_code) }}" download
