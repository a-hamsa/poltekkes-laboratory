...
<div class="flex flex-col mx-5">
    ...
    <div class="card flex flex-col bg-white text-gray-800 shadow-lg rounded-lg overflow-hidden">
        ...
        <div class="card-body px-6 pb-6">
            <form method="POST" action="{{ route('dashboard.tatib') }}" enctype="multipart/form-data"
                class="space-y-4">
                @csrf
                <div class="form-group flex flex-col">
                    <label for="pdf_file" class="mb-2 text-lg font-semibold">Upload PDF Tata Tertib</label>
