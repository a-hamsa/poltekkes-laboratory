...
<div class="container mx-auto px-6 pb-4">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-center">
                    <a href="{{ route('stok.edit', $stoks->id) }}" class="inline-flex items-center px-2 py-1 text-xs font-medium text-yellow-800 bg-yellow-100 rounded hover:bg-yellow-200">
                        Edit
                    </a>
                    <form action="{{ route('stok.destroy', $stoks->id) }}" method="post" class="inline">
                        @csrf
                        @method('DELETE')
    ...
    <a href="{{ route('stok.create') }}" class="btn bg-primary hover:bg-primary-dark transition duration-300 ease-in-out text-white px-6 py-3 rounded mt-6 inline-block">
